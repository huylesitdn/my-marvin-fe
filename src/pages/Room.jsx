...
const Room = ({ id, type }) => {
  ...
  const handleShare = async (type, data, mess) => {
    ...
    if (shared.payload._id) {
      ...
      const text = `${process.env.REACT_APP_URL}/shared/${shared.payload._id}`;
      setTimeout(() => {
                              ...
                              <img
                                ...
                                onClick={() =>
                                  handleView(
                                    mess,
                                    typeMess,
                                    typeMess === 'images' ? srcImg : choices[0].text
                                  )
                                }
                            ...
                            return (
                              <p
                                ...
                                className={`overflow-hidden cursor-pointer ${
                                  el.text.length > 300 ? 'whitespace-pre-line' : ''
                                }`}
                              >
                                {el.text}
                              </p>
